...
Sin duda, lso requerimientos de información a mayor detalle son los mas requeridos en estos tiempos , sobretod la sociodemográfica que es la base para la planificación territorial
a cualquier escala. En ese sentido en que describiemos este proceso que puede ser útil al momento de tomar decisiones.
...
- Procedemos a la selección como en el video se puede observar y generar el reporte en PDF ( la opción -XLS a mi no me funciona) sería ideal que la habiliten en *.CSV
